...
/ Run a Kerberized web-server as follows:
/ kdestroy && kinit -R -k -t /home/michaelg/.krb5/michaelg.keytab michaelg@MINDFRUIT.KRB
/ export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$(readlink -f ../krb5/lib)
/ export KRB5_KTNAME=~/.krb5/HTTP_fedora.keytab
/ export KRB5_TRACE=/dev/stdout
/ qq src/boot.q web -krb.server 1 -web.server 1 -web.home $(readlink -f ../krb5/html) -p 30097

.web.init:{
  rgs:.boot.getargs flip`name`reqd`default!(`web.server`web.home;00b;(0b;""))
 ;if[""~htm:rgs`web.home
    ;htm:getenv[`PWD],"html"
    ]
 ;.h.HOME:htm
...
.web.authComplete:{[G;H;S;C;T;V;X;O]
 ...
 ;.log.debug("authentication complete for URL param ";.web.tknFrag S)
 ;tkn:O except "\r\n"
...
.web.authIncomplete:{[G;H;S;C;T;V;X;O]
  .log.debug("authentication complete for URL param ";.web.tknFrag S;", responding to client with ";.web.tknFrag O)
...
.web.doInitialAccept:{[G;H;K;I]
  .log.debug("calling .krb.acceptSecCtx for auth_id ";.web.tknFrag I)
...
.web.continueAccept:{[G;H;K;I;X]
  .log.debug("calling .krb.acceptSecCtxCont for auth_id ";.web.tknFrag I)
...
// G: GET path 10h; H: header dict; K: token 10h; I: auth_id URL param value 10h
.web.handleTokenRequest:{[G;H;K;I]
  $[0=count tbl:select ctx from .web.webctx where not null ctx, sid~\:I
   ;.web.doInitialAccept[G;H;K;I]
   ;1=count tbl
...
.web.zac:{[T]
 ...
 ;rtn:$[1b~first usr:.web.tryCookieAuth hdr
       ...
       ;0b~tkn:.web.hasToken hdr
       ;.web.sendInitialChallenge[hdr;rid 1]
       ;.web.handleTokenRequest[qry;hdr;tkn 1;rid 1]
       ]
 ;rtn
 }
