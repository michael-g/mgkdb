...
unsigned char tenKQa_zipc[] = {
  
};
unsigned int tenKQa_zipc_len = 221;
...
{
	ReadBuf buf{(int8_t*)tenKQa_zipc, static_cast<uint64_t>(tenKQa_zipc_len)};
...
TEST(KdbIpcMessageReaderTest, TestRead10kQaViaMsgReader)
{
	...
	ReadMsgResult result{};
	bool complete = rdr.readMsg((int8_t*)tenKQa_zipc, static_cast<uint64_t>(tenKQa_zipc_len), result);
	EXPECT_TRUE(complete);
	EXPECT_EQ(ReadResult::RD_OK, result.result);

	EXPECT_EQ(0, rdr.getInputBytesRemaining());
	EXPECT_EQ(tenKQa_zipc_len, rdr.getInputBytesConsumed());
	...
	ReadBuf tmp{(int8_t*)tenKQa_zipc, static_cast<uint64_t>(tenKQa_zipc_len)};
